...
class OldCoupons extends StatefulWidget {
  @override
  _OldCouponsState createState() => _OldCouponsState();
}

class _OldCouponsState extends State<OldCoupons> {
  ...
  _getCopData() async {
    Firestore.instance.collection('copuons_sys').getDocuments().then((query) {
      ...
      getCoupons(true,Cart().convertToInt(_cop_count_use),context,user_id,
                          ...
                          child: Align(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Spacer(flex: 4,),
                                Text(
                                  AppModel.lamgug?'ارشيف الكوبونات':'All Coupons',
                                  style: TextStyle(
                                      fontFamily: 'Cairo',
                                      color: Colors.black54,
                                      fontSize: 15,
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              child: SmartRefresher(
                                ...
                                child: Container(child: _listLastVisitOrders(visits.oldListCuopon)),
                              ),
                            ),
                          ),
                        ),
